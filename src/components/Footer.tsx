    ...
    <footer className={styles.footer}>
      <div className={styles.container}>
        <div className={styles.top}>
          <div className={styles.brand}>
            ...
            <p className={styles.tagline}>
              Personalized English coaching that takes you further.
            </p>
          </div>
          ...
          <div className={styles.nav}>
            ...
            <Link href="/level-test">Level Test</Link>
            <Link href="/#about">About Eka</Link>
        ...
        <div className={styles.bottom}>
          <span>© {new Date().getFullYear()} English with Eka. All rights reserved.</span>
        </div>
      </div>
    </footer>
  );
